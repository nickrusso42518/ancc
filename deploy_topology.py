...
def main(gns3_control_host, snapshot_name):
    """
    Execution starts here.
    """

    # Load the topology generated by the Batfish testing, set GNS3 API base URL
    base_url = f"http://{gns3_control_host}:3080/v2"
    ...
    if True:
        ...
        for comp in _req(client, f"{base_url}/computes"):
            if comp["name"].startswith("GNS3 VM"):
                #print(f"GNS3 VM comp_id: {comp_id := comp['compute_id']}")
...
if __name__ == "__main__":
    ...
    # TODO can we do port 80 to the VM?
    main("192.168.120.1", "pre")
